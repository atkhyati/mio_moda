...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/appiconbg.png
  AssetGenImage get appiconbg =>
      const AssetGenImage('assets/icons/appiconbg.png');
  ...
  /// File path: assets/icons/coutry.png
  AssetGenImage get coutry => const AssetGenImage('assets/icons/coutry.png');

  /// File path: assets/icons/down_arrow.png
  AssetGenImage get downArrowPng =>
      const AssetGenImage('assets/icons/down_arrow.png');

  /// File path: assets/icons/down_arrow.svg
  String get downArrowSvg => 'assets/icons/down_arrow.svg';

  /// File path: assets/icons/downarrow.svg
  String get downarrow => 'assets/icons/downarrow.svg';

  /// File path: assets/icons/drawer.png
  AssetGenImage get drawerPng => const AssetGenImage('assets/icons/drawer.png');

  /// File path: assets/icons/drawer.svg
  String get drawerSvg => 'assets/icons/drawer.svg';
  ...
  /// File path: assets/icons/suvandnetlogo.png
  AssetGenImage get suvandnetlogo =>
      const AssetGenImage('assets/icons/suvandnetlogo.png');

  /// File path: assets/icons/tag.png
  AssetGenImage get tag => const AssetGenImage('assets/icons/tag.png');

  /// File path: assets/icons/titlelogo.svg
  String get titlelogo => 'assets/icons/titlelogo.svg';

  /// File path: assets/icons/uncheck.png
  AssetGenImage get uncheck => const AssetGenImage('assets/icons/uncheck.png');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/banner.jpeg
  AssetGenImage get banner => const AssetGenImage('assets/images/banner.jpeg');
  ...
  AssetGenImage get charity3 =>
      const AssetGenImage('assets/images/charity3.png');

  /// File path: assets/images/charity4.png
  AssetGenImage get charity4 =>
      const AssetGenImage('assets/images/charity4.png');

  /// File path: assets/images/charityOne.png
  AssetGenImage get charityOne =>
      const AssetGenImage('assets/images/charityOne.png');

  /// File path: assets/images/d_c.jpg
  AssetGenImage get dC => const AssetGenImage('assets/images/d_c.jpg');

  /// File path: assets/images/delete2.png
  AssetGenImage get delete2 => const AssetGenImage('assets/images/delete2.png');
  ...
  /// File path: assets/images/edit1.png
  AssetGenImage get edit1 => const AssetGenImage('assets/images/edit1.png');

  /// File path: assets/images/editPasword.png
  AssetGenImage get editPasword =>
      const AssetGenImage('assets/images/editPasword.png');
  ...
  /// File path: assets/images/gucci.jpg
  AssetGenImage get gucci => const AssetGenImage('assets/images/gucci.jpg');
  ...
  AssetGenImage get imgShadow =>
      const AssetGenImage('assets/images/img_shadow.png');

  /// File path: assets/images/kenzo.jpg
  AssetGenImage get kenzo => const AssetGenImage('assets/images/kenzo.jpg');

  /// File path: assets/images/logo.png
  AssetGenImage get logo => const AssetGenImage('assets/images/logo.png');

  /// File path: assets/images/marcjacobs.jpg
  AssetGenImage get marcjacobs =>
      const AssetGenImage('assets/images/marcjacobs.jpg');

  /// File path: assets/images/miumiu.jpg
  AssetGenImage get miumiu => const AssetGenImage('assets/images/miumiu.jpg');

  /// File path: assets/images/mochino.jpg
  AssetGenImage get mochino => const AssetGenImage('assets/images/mochino.jpg');
  ...
  /// File path: assets/images/prada.jpg
  AssetGenImage get prada => const AssetGenImage('assets/images/prada.jpg');

  /// File path: assets/images/saintlaurent.jpg
  AssetGenImage get saintlaurent =>
      const AssetGenImage('assets/images/saintlaurent.jpg');
  ...
  AssetGenImage get shoppingBasket =>
      const AssetGenImage('assets/images/shoppingBasket.png');

  /// File path: assets/images/shoppingCart.png
  AssetGenImage get shoppingCart =>
      const AssetGenImage('assets/images/shoppingCart.png');
...
class $AssetsSvgGen {
  ...
  /// File path: assets/svg/BG_home.png
  AssetGenImage get bGHome => const AssetGenImage('assets/svg/BG_home.png');

  /// File path: assets/svg/addtocart.svg
  String get addtocart => 'assets/svg/addtocart.svg';

  /// File path: assets/svg/addtowishlist.svg
  String get addtowishlist => 'assets/svg/addtowishlist.svg';

  /// File path: assets/svg/appLogo.svg
  String get appLogo => 'assets/svg/appLogo.svg';

  /// File path: assets/svg/appMenu.svg
  String get appMenu => 'assets/svg/appMenu.svg';

  /// File path: assets/svg/baby.svg
  String get baby => 'assets/svg/baby.svg';

  /// File path: assets/svg/baby_filled.svg
  String get babyFilled => 'assets/svg/baby_filled.svg';

  /// File path: assets/svg/backgrondPattern.svg
  String get backgrondPattern => 'assets/svg/backgrondPattern.svg';
  ...
  /// File path: assets/svg/flower_filled.svg
  String get flowerFilled => 'assets/svg/flower_filled.svg';
...
class $AssetsImagesHomeGen {
  ...
  /// File path: assets/images/home/all.png
  AssetGenImage get all => const AssetGenImage('assets/images/home/all.png');

  /// File path: assets/images/home/boys.png
  AssetGenImage get boys => const AssetGenImage('assets/images/home/boys.png');

  /// File path: assets/images/home/brands.png
  AssetGenImage get brands =>
      const AssetGenImage('assets/images/home/brands.png');

  /// File path: assets/images/home/girls.png
  AssetGenImage get girls =>
      const AssetGenImage('assets/images/home/girls.png');

  /// File path: assets/images/home/home1.png
  AssetGenImage get home1 =>
      const AssetGenImage('assets/images/home/home1.png');

  /// File path: assets/images/home/home2.png
  AssetGenImage get home2 =>
      const AssetGenImage('assets/images/home/home2.png');

  /// File path: assets/images/home/home3.png
  AssetGenImage get home3 =>
      const AssetGenImage('assets/images/home/home3.png');

  /// File path: assets/images/home/home4.png
  AssetGenImage get home4 =>
      const AssetGenImage('assets/images/home/home4.png');

  /// File path: assets/images/home/home5.png
  AssetGenImage get home5 =>
      const AssetGenImage('assets/images/home/home5.png');

  /// File path: assets/images/home/left_hold_container.png
  AssetGenImage get leftHoldContainer =>
      const AssetGenImage('assets/images/home/left_hold_container.png');

  /// File path: assets/images/home/right_hold_container.png
  AssetGenImage get rightHoldContainer =>
      const AssetGenImage('assets/images/home/right_hold_container.png');
