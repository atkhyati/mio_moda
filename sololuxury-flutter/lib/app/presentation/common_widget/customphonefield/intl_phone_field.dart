...
class IntlPhoneField extends StatefulWidget {
  ...
  /// {@macro flutter.widget.editableText.readOnly}
  final bool readOnly;
  final FormFieldSetter<PhoneNumber>? onSaved;

  /// {@macro flutter.widget.editableText.onChanged}
  ///
  /// See also:
  ///
  ...
  /// {@macro flutter.widget.editableText.keyboardType}
  ...
  /// {@macro flutter.widget.editableText.onSubmitted}
  ///
  /// See also:
  ///
  ...
  /// {@macro flutter.widget.editableText.inputFormatters}
...
class _IntlPhoneFieldState extends State<IntlPhoneField> {
  ...
  void initState() {
    ...
    _countryList = widget.countries == null
        ...
        : countries
            .where(
                (country) => widget.countries?.contains(country.code) ?? false)
            .toList();
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                if (widget.showCountryFlag) ...[
                  Image.asset(
                    'assets/flags/${_selectedCountry.code.toLowerCase()}_flag.png',
