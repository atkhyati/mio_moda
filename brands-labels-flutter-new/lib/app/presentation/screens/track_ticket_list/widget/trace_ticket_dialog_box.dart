...
import '../../../../controller/track_ticket_controller.dart';

class TraceTicketDialogBox extends StatelessWidget {
  TraceTicketDialogBox({Key? key, required this.ticket}) : super(key: key);
