...
class CustomAppBarSpecialSize extends GetView<SpecialSizeRequestController> {
  final List<String> imgList;
  final CarouselController caController;
  CustomAppBarSpecialSize({
    Key? key,
              ...
              children: [
                ...
                Expanded(
                  child: CarouselSlider(
                    ...
                    carouselController: caController,
                    items: imgList
                        .map((item) => Center(
