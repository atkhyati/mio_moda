...
import com.example.veralusso.model.*
import com.example.veralusso.paymentmethod.PaymentMethodData
import com.example.veralusso.apiservice.APIClient
import com.example.veralusso.inerface.ApiInterface
import com.example.veralusso.model.*
...
//                    setupCardView(responsePayments)
    ...
    private fun setupCardView(paymentMethod: PaymentMethod, arguments: Arguments) {
      val cardConfiguration = CardConfiguration.Builder(this@CardActivity, "test_7E6J4E435VBR5OCXOEXTCIX4Y4IA2YXB").build()
...
//        }
    ...
    private fun postPayment(paymentComponentData: JSONObject, arguments: Arguments) {
        ...
        jsonPayRequestData.reference =  arguments.reference
